...
export class Polygon {
  ...
  transform(m) {
    return new Polygon(this.data.map(d => {
      return { ...d, position: d.position.transformMat4(m)};
...
class Model {
  ...
  rotate(...args) {
    return new Model(this, Mat4.rotate(...args).mul(this.matrix));
  }
  translate(...args) {
    return new Model(this, Mat4.translate(...args).mul(this.matrix));
  }
  lookAt(...args) {
    return new Model(this, Mat4.lookAt(...args).mul(this.matrix));
  }
  ortho(...args) {
    return new Model(this, Mat4.ortho(...args).mul(this.matrix));
  }
  perspective(...args) {
    return new Model(this, Mat4.perspective(...args).mul(this.matrix));
  }
}
