...
export { V3, Vec3, M4, Mat4 };

export const x_axis = V3(1, 0, 0);
export const y_axis = V3(0, 1, 0);
export const z_axis = V3(0, 0, 1);

export function intersection_of_plane_and_line(A: Vec3, B: Vec3, C: Vec3, D: Vec3, E: Vec3) {
  const F = E.sub(D);
...
export function triangle_contains_point(A: Vec3, B: Vec3, C: Vec3, Q: Vec3) {
...
export function grid_rect_collision_lt(
