export function program(
  gl: WebGLRenderingContext, vss: string, fss: string
) {
...
export function uniform(
  gl: WebGLRenderingContext, prg: WebGLProgram,
...
export function attribute(
  gl: WebGLRenderingContext, prg: WebGLProgram,
  vbo: WebGLBuffer, name: string, stride: number
) {
...
export function buffer(
  gl: WebGLRenderingContext, type: number, value: any
) {
...
export const FRAGMENT_SOURCE: string = `
