import { V3, x_axis, y_axis, z_axis } from "./math/geometry/index";
import { Triangles } from "./primitives";

export { Triangles };

export function rect(x: number, y: number, color = [1, 1, 1]) {
  const data = [
...
export function quarter_cylinder_rect(h: number, r: number, color = [1, 1, 1], c = 32) {
  const data = [], index = [];
  for (let i = 0; i <= c; i++) {
...
export function one_eighth_sphere(r: number, color = [1, 1, 1], c = 16) {
  const data = [], index = [];
  for (let i = 0; i <= c; i++) {
...
export function sphere(r: number, color = [1, 1, 1], c = 16) {
...
export function cube(w: number, color = [1, 1, 1]) {
...
export function rounded_corners_cube(w: number, r: number, color = [1, 1, 1]) {
